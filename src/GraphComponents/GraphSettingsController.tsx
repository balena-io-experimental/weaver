...
export const GraphSettingsController: FC<GraphSettingsControllerProps> = ({ children, hoveredNode }) => {
   ...
   */
  useEffect(() => {
    sigma.setSetting("hoverRenderer", (context: any, data: any, settings: any) =>
